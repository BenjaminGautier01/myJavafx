...
public class DeleteDepartment  extends DataBaseConnection implements IDelete {
    ...
    public void delete() throws SQLException {
        try {
            ...
            System.out.println("Enter the StudentID to delete the Department: ");
            int StudentID = sc.nextInt();

            String sql_query = "UPDATE sis.student " +
                               "SET DepartmentName = NULL, DepartmentID = NULL " +
                               "WHERE StudentID = ?";
