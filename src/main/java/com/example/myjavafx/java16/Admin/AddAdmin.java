...
public class AddAdmin extends DataBaseConnection implements IAdd {
    ...
    // For the Console or CommandLine interface
    @Override
    public void add() throws SQLException {
        ...
        try {
            ...
            Admin newAdmin = new Admin(ID, firstName, lastName, gender, dateOfBirth, email, password, ConfirmPassword);

            //Student student = (Student)newStudent;
            adminMap.put(newAdmin.getID(), newAdmin);
